...
if ($("#pageWrapper").hasClass("compact-wrapper modern-type")) {
  ...
  const horizontalMenu = () => {
    ...
    if (contentwidth <= 992 && !smallSize) {
      ...
      $("#pageWrapper")
        ...
        .addClass("compact-wrapper modern-type");
      $(".page-body-wrapper")
    ...
    if (contentwidth > 992 && !bigSize) {
      ...
      $("#pageWrapper")
        .removeClass("compact-wrapper modern-type")
...
if (
  ...
  $("#pageWrapper").hasClass("compact-wrapper modern-type")
) {
