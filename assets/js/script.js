/*! -----------------------------------------------------------------------------------
    Template Name: Roko Admin
    Template URI: http://admin.pixelstrap.com/Roko/theme
...
(function ($) {
  ...
  $(".mode").on("click", function () {
    ...
    if (!bodyModeDark) {
      ...
      localStorage.setItem("mode-Roko", "dark-only");
      $("body").addClass("dark-only");
      $("body").removeClass("light");
    }
    if (bodyModeDark) {
      $(".mode").removeClass("active");
      localStorage.setItem("mode-Roko", "light");
      $("body").removeClass("dark-only");
      $("body").addClass("light");
    }
  });
  $("body").addClass(
    localStorage.getItem("mode-Roko")
      ? localStorage.getItem("mode-Roko")
      : "light"
  );
  $(".mode").addClass(
    localStorage.getItem("mode-Roko") === "dark-only" ? "active" : " "
  );
  // sidebar filter
