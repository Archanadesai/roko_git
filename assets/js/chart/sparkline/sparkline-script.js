(function ($) {
  ...
  setTimeout(function () {
    $("#line-chart-sparkline").sparkline(
      [5, 10, 20, 14, 17, 21, 20, 10, 4, 13, 0, 10, 30, 40, 10, 15, 20],
      {
        ...
        lineColor: RokoAdminConfig.primary,
        fillColor: "rgba(145, 46, 252, 0.40)",
        highlightLineColor: RokoAdminConfig.primary,
        highlightSpotColor: RokoAdminConfig.primary,
        targetColor: RokoAdminConfig.primary,
        performanceColor: RokoAdminConfig.primary,
        boxFillColor: RokoAdminConfig.primary,
        medianColor: RokoAdminConfig.primary,
        minSpotColor: RokoAdminConfig.primary,
      }
    );
  });
  ...
  $("#custom-line-chart").sparkline([5, 30, 27, 35, 30, 50, 70], {
    ...
    tooltipClassname: "chart-sparkline",
    chartRangeMax: "50",
    lineColor: RokoAdminConfig.secondary,
    ...
    init: function () {
      setTimeout(function () {
        ...
        $("#bar-chart-sparkline").sparkline([5, 2, 2, 4, 9, 5, 7, 5, 2, 2, 6], {
          ...
          height: "100%",
          tooltipClassname: "chart-sparkline",
          barColor: RokoAdminConfig.primary,
        }),
