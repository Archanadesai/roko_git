  ...
  var morris_chart = {
    init: function () {
      Morris.Area({
        ...
        ykeys: ["y", "z"],
        labels: ["Y", "Z"],
        lineColors: [RokoAdminConfig.secondary, RokoAdminConfig.primary],
      }),
        Morris.Line({
          ...
          xkey: "y",
          ykeys: ["a", "b"],
          lineColors: [RokoAdminConfig.primary, RokoAdminConfig.secondary],
        ...
        Morris.Bar({
          ...
          ykeys: ["y"],
          labels: ["Y"],
          barColors: [RokoAdminConfig.primary],
        }),
        $(function () {
          var b = [
            {
          ...
          Morris.Bar({
            ...
            data: b,
            barColors: [RokoAdminConfig.primary, RokoAdminConfig.secondary],
            xkey: "period",
        ...
        $(function () {
          ...
          window.m = Morris.Line({
            ...
            labels: ["sin(x)"],
            parseTime: !1,
            lineColors: [RokoAdminConfig.primary],
