    ...
    datasets: [
      {
        ...
        highlightStroke: RokoAdminConfig.primary,
        data: [35, 59, 80, 81, 56, 55, 40],
      },
      {
        label: "My Second dataset",
        fillColor: "rgba(247, 49, 100, 0.4)",
        strokeColor: RokoAdminConfig.secondary,
        highlightFill: "rgba(247, 49, 100, 0.6)",
        highlightStroke: RokoAdminConfig.secondary,
  ...
  var polarData = [
    {
      ...
      highlight: RokoAdminConfig.primary,
      label: "Yellow",
    },
    {
      value: 50,
    ...
    },
    {
      ...
      highlight: RokoAdminConfig.secondary,
      label: "Dark Grey",
    },
  ];
  var polarOptions = {
    ...
    datasets: [
      {
        ...
        strokeColor: RokoAdminConfig.primary,
        pointColor: RokoAdminConfig.primary,
      ...
      },
      {
        ...
        strokeColor: RokoAdminConfig.secondary,
        pointColor: RokoAdminConfig.secondary,
        pointStrokeColor: "#fff",
        pointHighlightFill: "#000",
        pointHighlightStroke: RokoAdminConfig.secondary,
        data: [28, 48, 40, 19, 86, 27, 90],
      },
    ],
  };
    ...
    datasets: [
      {
        ...
        strokeColor: RokoAdminConfig.primary,
        pointColor: RokoAdminConfig.primary,
        pointStrokeColor: RokoAdminConfig.primary,
        pointHighlightFill: RokoAdminConfig.primary,
