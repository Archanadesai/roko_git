        ...
        function plotAccordingToChoices() {
            ...
            if (data.length > 0) {
                $.plot("#toggling-series-flot", data, {
                    ...
                    colors: [woolAdminConfig.primary, "#f8d62b" ,"#a927f9" ,"#51bb25" , woolAdminConfig.secondary , "#dc3545" ,"#f8d62b"]
...
$(function() {
    ...
    $.plot('#default-pie-flot-chart', data, {
        ...
        colors: [ woolAdminConfig.primary , "#51bb25" ,"#f8d62b" ,"#a927f9" ,"#dc3545", "#6c757d" , woolAdminConfig.secondary ]
    });
