...
var morris_chart = {
    init: function() {
        Morris.Area({
            ...
            ykeys: ['y', 'z'],
            labels: ['Y', 'Z'],
            lineColors: [woolAdminConfig.secondary , woolAdminConfig.primary ],
        }), Morris.Line({
            ...
            xkey: "y",
            ykeys: ["a", "b"],
            lineColors: [woolAdminConfig.primary , woolAdminConfig.secondary ],
            ...
            xkey: "x",
            ykeys: ["y", "z", "a"],
            barColors: [woolAdminConfig.primary , woolAdminConfig.secondary ,"#51bb25"],
            labels: ["Y", "Z", "A"]
        }), Morris.Bar({
            ...
            ykeys: ["y"],
            labels: ["Y"],
            barColors: [woolAdminConfig.primary]
        }), $(function() {
            var b = [{
                period: "2012-10-01",
                licensed: 5000,
            ...
            Morris.Bar({
                ...
                data: b,
                barColors: [woolAdminConfig.primary , woolAdminConfig.secondary ],
                xkey: "period",
            ...
            window.m = Morris.Line({
                ...
                labels: ["sin(x)"],
                parseTime: !1,
                lineColors: [woolAdminConfig.primary],
            ...
            Morris.Donut({
                ...
                labelColor: "#999999",
                colors: [woolAdminConfig.primary , woolAdminConfig.secondary ,"#f8d62b" ,"#51bb25" ,"rgba(248, 214, 43, 1)", "#51bb25" ,"#f8d62b"],
            ...
            Morris.Bar({
                ...
                ykeys: ["y", "z", "a"],
                labels: ["A", "Y", "Z"],
                barColors: [woolAdminConfig.primary , woolAdminConfig.secondary ,"#51bb25" ,"#f8d62b" ,"#a927f9", woolAdminConfig.secondary , woolAdminConfig.primary ],
                stacked: !0
            });
        });
    }
