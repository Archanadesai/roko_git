...
function drawBasic() {
  if ($("#column-chart1").length > 0) {
      ...
      b = {
        ...
        height: 400,
        width:'100%',
          colors: [woolAdminConfig.primary, woolAdminConfig.secondary , "#51bb25"]
  ...
  if ($("#pie-chart1").length > 0) {
      ...
      var options = {
        ...
        width:'100%',
        height: 300,
       colors: ["#f8d62b", "#51bb25" , "#a927f9"  , woolAdminConfig.secondary , woolAdminConfig.primary ]
      };
  ...
  if ($("#pie-chart2").length > 0) {
      ...
      var options = {
        ...
        width:'100%',
        height: 300,
        colors: ["#f8d62b", "#a927f9" , "#51bb25", woolAdminConfig.secondary , woolAdminConfig.primary ]
      };
  ...
  if ($("#pie-chart4").length > 0) {
      ...
      var options = {
        ...
        slices: {  4: {offset: 0.2},
          ...
          colors: ["#dc3545", woolAdminConfig.primary , woolAdminConfig.secondary , "#51bb25", "#a927f9", "#f8d62b","#dc3545", woolAdminConfig.primary , "#f8d62b", "#51bb25", woolAdminConfig.primary , woolAdminConfig.secondary ,"#51bb25", woolAdminConfig.primary , "#a927f9", "#f8d62b", woolAdminConfig.primary , woolAdminConfig.primary, "#a927f9", woolAdminConfig.secondary , woolAdminConfig.primary , "#51bb25"]
        };
  ...
  if ($("#combo-chart").length > 0) {
      ...
      var options = {
        ...
        height: 500,
        width:'100%',
        colors: [woolAdminConfig.primary, woolAdminConfig.secondary , "#51bb25", "#a927f9", "#f8d62b"]
    };
  ...
  if ($("#area-chart2").length > 0) {
    ...
    var options = {
      ...
      width:'100%',
      height: 400,
      colors: [woolAdminConfig.primary , woolAdminConfig.secondary , "#51bb25", "#f8d62b"]
    };
                ...
                palette: [
                    {
                        ...
                        "dark": woolAdminConfig.secondary ,
                        "light": "#047afb"
                    }
                ]
