...
var barData = {
    ...
    datasets: [{
        ...
        strokeColor: woolAdminConfig.primary,
        highlightFill: "rgba(115, 102 ,255, 0.6)",
        highlightStroke: woolAdminConfig.primary ,
        data: [35, 59, 80, 81, 56, 55, 40]
    }, {
        label: "My Second dataset",
        fillColor: "rgba(247, 49, 100, 0.4)",
        strokeColor: woolAdminConfig.secondary ,
        highlightFill: "rgba(247, 49, 100, 0.6)",
        highlightStroke: woolAdminConfig.secondary,
...
var polarData = [
    {
        ...
        highlight: woolAdminConfig.primary,
        label: "Yellow"
    }, {
        value: 50,
        color: "#f8d62b",
        ...
        highlight: woolAdminConfig.secondary ,
        label: "Dark Grey"
    }
];
var polarOptions = {
...
var lineGraphData = {
    ...
    datasets: [{
        ...
        strokeColor: woolAdminConfig.primary ,
        pointColor: woolAdminConfig.primary ,
        ...
        strokeColor: woolAdminConfig.secondary ,
        pointColor: woolAdminConfig.secondary ,
        pointStrokeColor: "#fff",
        pointHighlightFill: "#000",
        pointHighlightStroke: woolAdminConfig.secondary,
        data: [28, 48, 40, 19, 86, 27, 90]
    }]
};
...
var radarData = {
    ...
    datasets: [{
        ...
        strokeColor: woolAdminConfig.primary,
        pointColor: woolAdminConfig.primary,
        pointStrokeColor: woolAdminConfig.primary,
        pointHighlightFill: woolAdminConfig.primary ,
